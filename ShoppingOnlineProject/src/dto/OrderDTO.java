...
public class OrderDTO implements Serializable{
    ...
    public OrderDTO(String orderId, String createdTime, int point, boolean isAvailable, String code, String cusId) {
    ...
    public OrderDTO(String orderId, int point, String code, String cusId) {
        this.orderId = orderId;
        this.point = point;
        this.code = code;
        this.cusId = cusId;
